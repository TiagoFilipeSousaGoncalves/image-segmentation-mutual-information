...
for dataset in datasets:
    ...
    # Loss function
    loss = RMILoss(num_classes=train_dataset.num_classes, rmi_radius=3, rmi_pool_way=0, rmi_pool_size=0, rmi_pool_stride=0, loss_weight_lambda=0.5, lambda_way=True)
    ...
    for epoch in range(epochs):
        ...
        if avg_running_loss < min_loss:
            ...
            # Weights directory
            weights_dir = "results/rmi/weights"
